...
<template>
    ...
    >
      ...
      <div class="mb-6 flex items-center justify-between gap-3">
        <NuxtLink to="/academy" class="flex items-center gap-2">
          <span class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-100 text-sm font-semibold text-emerald-700">
            LH
          </span>
          <span class="flex flex-col leading-tight">
            <span class="text-xs font-semibold text-slate-500">LicenceHub</span>
            <span class="text-sm font-semibold text-slate-900">Academy</span>
          </span>
        </NuxtLink>
